...
function vector_metatable.__call (table, ...) -- multiplex constructor
  local args = {...}
...
function vector:__tostring () -- quality of life
...
function vector.__eq (a, b) -- equality operator
  return a.x == b.x and a.y == b.y
end

function vector.__add (a, b) -- math operators
  assert_vectors(a, b)
